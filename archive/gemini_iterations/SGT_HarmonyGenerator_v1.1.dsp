...
// ==================== PROCESS ====================
// STEREO: Takes stereo in, outputs stereo (same processing on both channels)

process = _, _ : harmony_processor, harmony_processor
with {
    harmony_processor = _ <: dry_signal, h1_signal, h2_signal :> _
    with {
