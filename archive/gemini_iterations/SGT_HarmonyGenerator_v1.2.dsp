// =================================================================================
// SGT Harmony Generator v1.2
// Based on official Faust pitch shifter example
// THREE VOICES: Dry + Harmony 1 + Harmony 2
// PROPER STEREO OUTPUT - Each channel processed independently
// =================================================================================
...
// ==================== PITCH SHIFTER CORE ====================
// Using official ef.transpose from Faust standard library
...
// ==================== MONO PROCESSOR ====================
// Process one channel: split into 3 voices, sum back

mono_processor = _ <: dry_signal, h1_signal, h2_signal :> _
with {
...
// ==================== PROCESS ====================
// Apply mono processor to BOTH left and right channels

process = mono_processor, mono_processor;
